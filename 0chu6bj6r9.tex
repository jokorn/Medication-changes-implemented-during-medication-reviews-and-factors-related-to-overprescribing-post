...
\multirow{2}{*}{} &
  ...
  \multicolumn{2}{p{4cm}}{\textbf{Persistent changes at 13   months, No. (\% of changes at first visit)}} \\ \cmidrule(l){2-7} 
                                   & \multicolumn{2}{p{4cm}}\textbf{Medication review} & \textbf{Usual care} & \textbf{Medication review} & \textbf{Usual care} & \textbf{Medication review} & \textbf{Usual care} \\ \cmidrule(lr){1-7}
