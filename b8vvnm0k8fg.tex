...
\multirow{2}{=}{} &
  ...
  \multicolumn{2}{>{\centering}m{4.5cm}}{\textbf{Full model}} &
  \multicolumn{2}{>{\centering}m{4.5cm}}{\textbf{Univariate model}} \\ \cmidrule(lr){3-6} 

                                           &             & \textbf{Exponentiated  \boldmath$\beta$ \textbf{(95\% CI)} & \textbf{P value} & \textbf{Exponentiated} \boldmath$\beta$ \textbf{(95\% CI)} & \textbf{P value}        \\ \cmidrule(r){1-6}
