...
\toprule
\multirow{2}{=}[-3em]{\textbf{Medicine}} & \multirow{2}{=}[-1em]{\raggedleft\textbf{Discontinued   at first visit, No. discontinued / No. at baseline = \% discontinued}}
   &
  \multicolumn{2}{m{8cm}}{\textbf{Proportion restarted, No.   restarted / No. discontinued at first visit = \% restarted}} \\ \cmidrule(l){3-4} 
                                  &               & \textbf{Follow-up at 4   months} & \textbf{Follow-up at 13 months} \\ \cmidrule(lr){1-4}
