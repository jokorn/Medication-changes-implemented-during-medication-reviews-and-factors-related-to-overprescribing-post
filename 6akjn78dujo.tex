...
\multirow{2}{=}[-3.5em]{\textbf{Medicine}} &
  \multicolumn{2}{m{5.7cm}}{\textbf{Discontinued at first visit, No. discontinued / No. at   baseline = \% discontinued}} &
   \\ \cmidrule(lr){2-3}           & \textbf{Medication review (n = 196)} & \textbf{Usual care (n = 212)} &   \textbf{Absolute difference, No. (\%)}      \\ \cmidrule(lr){1-4}
