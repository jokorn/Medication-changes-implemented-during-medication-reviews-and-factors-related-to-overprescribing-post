...
\toprule
 &
  \multicolumn{2}{>{\raggedright}m{9cm}}{\textbf{Discontinued at first visit, \newline No. discontinued / No. at   baseline = \% discontinued}} &
   \\ \cmidrule(lr){2-3}
              \textbf{Medicine}              & \textbf{Medication review  \newline (n = 196)} & \textbf{Usual care \newline (n = 212)} &   \textbf{Absolute difference, \newline No. (\%)}      \\ \cmidrule(lr){1-4}
