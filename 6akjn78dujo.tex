...
\toprule
\multirow{2}{3cm}{\textbf{Medicine}} &
  \multicolumn{2}{p{6cm}}{\textbf{Discontinued at first visit, No. discontinued / No. at   baseline = \% discontinued}} &
  \multirow{2}{3cm}{\textbf{Absolute difference, No. (\%)}} \\ \cmidrule(lr){2-3}
                            & \textbf{Medication review   (n = 196)} & Usual care (n = 212) &         \\ \cmidrule(lr){1-4}
