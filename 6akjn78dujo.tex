...
\toprule
 &
  \multicolumn{2}{p{8cm}}{\textbf{Discontinued at first visit, No. discontinued / No. at   baseline = \% discontinued}} &
  \textbf{Absolute difference, No. (\%)} \\ \cmidrule(lr){2-3}
              \textbf{Medicine}              & \textbf{Medication review   (n = 196)} & \textbf{Usual care (n = 212)} &         \\ \cmidrule(lr){1-4}
